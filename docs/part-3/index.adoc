...
[source,shell]
----
$ helm install elasticsearch elastic/elasticsearch -n logging -f elasticsearch-opensearch-values.yaml
...
[source,shell]
----
$ helm install kibana elastic/kibana -n logging -f kibana-opensearch-values.yaml
----
...
[source,shell]
----
$ helm install kibana elastic/kibana -n logging -f kibana-minikube-opensearch-values.yaml
----
